declare global {
  const ReadJson: typeof import('../../server/utils/json-handle')['ReadJson']
  const WriteJson: typeof import('../../server/utils/json-handle')['WriteJson']
  ...
  const all_path: typeof import('../../server/utils/menu')['all_path']
  ...
  const dateformatFr_: typeof import('../../server/utils/date-utils')['dateformatFr_']
  const dateformatFr_long: typeof import('../../server/utils/date-utils')['dateformatFr_long']
  ...
  const deleteFile: typeof import('../../server/utils/deleteFile')['deleteFile']
  const dynamicEventHandler: typeof import('../../node_modules/h3')['dynamicEventHandler']
  const emailSend: typeof import('../../server/utils/emailSend')['default']
  const eventHandler: typeof import('../../node_modules/h3')['eventHandler']
  const fetchWithEvent: typeof import('../../node_modules/h3')['fetchWithEvent']
  const fromNodeMiddleware: typeof import('../../node_modules/h3')['fromNodeMiddleware']
  const fromPlainHandler: typeof import('../../node_modules/h3')['fromPlainHandler']
  const fromWebHandler: typeof import('../../node_modules/h3')['fromWebHandler']
  const generatePDF: typeof import('../../server/utils/generatePdf')['generatePDF']
  const generateXLS: typeof import('../../server/utils/generateXls')['generateXLS']
  ...
  const my_menu: typeof import('../../server/utils/menu')['my_menu']
  const my_sub_menu: typeof import('../../server/utils/menu')['my_sub_menu']
  const my_sub_menu_card: typeof import('../../server/utils/menu')['my_sub_menu_card']
  ...
  const readFromFilesDirectory: typeof import('../../server/utils/send-photo')['readFromFilesDirectory']
  ...
  const saveFile: typeof import('../../server/utils/saveFile')['saveFile']
  ...
  const useFile: typeof import('../../server/utils/useFile')['default']
  ...
  const variable: typeof import('../../server/utils/variable')['default']
  const writeEarlyHints: typeof import('../../node_modules/h3')['writeEarlyHints']
}
// for type re-export
declare global {
  // @ts-ignore
  export type { FileObject, BusboyBody } from '/home/camoes/Documents/20240316_fromzero/server/utils/type.d.ts'
  import('/home/camoes/Documents/20240316_fromzero/server/utils/type.d.ts')
}
...
export { dateformatFr_, dateformatFr_long } from '../../server/utils/date-utils';
export { deleteFile } from '../../server/utils/deleteFile';
export { default as emailSend } from '../../server/utils/emailSend';
export { generatePDF } from '../../server/utils/generatePdf';
export { generateXLS } from '../../server/utils/generateXls';
export { WriteJson, ReadJson } from '../../server/utils/json-handle';
export { my_menu, my_sub_menu, my_sub_menu_card, all_path } from '../../server/utils/menu';
export { saveFile } from '../../server/utils/saveFile';
export { readFromFilesDirectory } from '../../server/utils/send-photo';
export { default as useFile } from '../../server/utils/useFile';
export { default as variable } from '../../server/utils/variable';