import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, version as version$1, ref, watchEffect, watch, computed, toValue, reactive, readonly, defineComponent as defineComponent$1, shallowRef, toRefs, shallowReactive, h, Transition, toRef, inject as inject$2, createVNode, mergeProps, nextTick, provide, onScopeDispose, withDirectives, vShow, Fragment, resolveDirective, capitalize as capitalize$2, unref, Suspense, onServerPrefetch, resolveComponent, camelize, toRaw, TransitionGroup, isRef, Text, resolveDynamicComponent, effectScope, warn as warn$1, Teleport, cloneVNode, createTextVNode, vModelText, useSSRContext, createApp, isVNode, Comment, isReactive, onUpdated, openBlock, createBlock, withCtx, renderSlot, createElementBlock, toDisplayString, createCommentVNode, defineAsyncComponent, onErrorCaptured, isReadonly, getCurrentScope, shallowReadonly, createElementVNode, normalizeClass, normalizeStyle, withModifiers, withKeys, normalizeProps, guardReactiveProps, markRaw, isShallow, render } from 'vue';
import { u as useRuntimeConfig$1, $ as $fetch$1, w as withQuery, h as hasProtocol, a as parseURL, i as isScriptProtocol, j as joinURL, c as createError$1, b as getRequestHeaders, e as hash, f as defu, k as sanitizeStatusCode, l as parseQuery, m as createHooks, n as withTrailingSlash, o as withoutTrailingSlash, q as appendHeader, t as sendRedirect, v as parse, x as getRequestHeader, y as destr, z as isEqual$1, A as setCookie, B as getCookie, C as deleteCookie } from '../.get.mjs';
...
function injectHead() {
  ...
  const head = inject$2(headSymbol);
...
const useRoute$1 = () => {
  if (hasInjectionContext()) {
    return inject$2(PageRouteSymbol, (/* @__PURE__ */ useNuxtApp())._route);
  }
...
const __nuxt_page_meta = {
  layout: "homemaintenance",
  auth: false,
  middleware: ["maintenancesite"]
  /*  middleware:[
  async function (to, from) {
   let response = await useFetch("/api/maintenance");
   let maintenance_ = response.data.value;
     if (maintenance_?.status == false) {
       //this.$router.push("/");
       //return navigateTo("/");
...
const _routes = [
  {
    name: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.name) ?? "change-password",
    path: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.path) ?? "/change-password",
    meta: __nuxt_page_meta$3 || {},
    alias: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.alias) || [],
    redirect: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.redirect) || void 0,
    component: () => import('./_nuxt/change-password-6bcc53ea.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.name) ?? "connexion",
    path: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.path) ?? "/connexion",
    meta: __nuxt_page_meta$2 || {},
    alias: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.alias) || [],
    redirect: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.redirect) || void 0,
    component: () => import('./_nuxt/connexion-5dae243e.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-08e44477.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "maintenance",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/maintenance",
    meta: __nuxt_page_meta || {},
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/maintenance-80f0ad9a.mjs').then((m) => m.default || m)
  },
  {
    path: "/tableau-de-bord",
    children: [
      {
        name: "tableau-de-bord-candidats",
        path: "candidats",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/index-58a153d8.mjs').then((m) => m.default || m)
      },
      {
        name: "tableau-de-bord-configuration",
        path: "configuration",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/index-236c1fd9.mjs').then((m) => m.default || m)
      },
      {
        name: "tableau-de-bord-configuration-signataires",
        path: "configuration/signataires",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/signataires-c3919c06.mjs').then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/index-7d13d029.mjs').then((m) => m.default || m)
      },
      {
        name: "tableau-de-bord-mon-compte",
        path: "mon-compte",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/mon-compte-aa2ab14f.mjs').then((m) => m.default || m)
      },
      {
        name: "tableau-de-bord-sessions",
        path: "sessions",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/index-00a88b98.mjs').then((m) => m.default || m)
      },
      {
        name: "tableau-de-bord-utilisateurs-profils",
        path: "utilisateurs-profils",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/index-3ac46d1c.mjs').then((m) => m.default || m)
      },
      {
        name: "tableau-de-bord-utilisateurs-profils-profils",
        path: "utilisateurs-profils/profils",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/profils-8ef6cc30.mjs').then((m) => m.default || m)
      },
      {
        name: "tableau-de-bord-utilisateurs-profils-utilisateurs",
        path: "utilisateurs-profils/utilisateurs",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/utilisateurs-5052e38b.mjs').then((m) => m.default || m)
      }
    ],
    name: void 0,
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/tableau-de-bord-24dc4550.mjs').then((m) => m.default || m)
  }
];
...
const getApiURL = () => {
  const origin = (/* @__PURE__ */ useRuntimeConfig()).public.auth.origin ?? ("");
  return joinURL(origin, (/* @__PURE__ */ useRuntimeConfig()).public.auth.basePath);
};
...
const change_45password_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to, redirect) => {
  var _a, _b, _c, _d;
  const { status, signOut: signOut2, data } = useSession();
  if (((_b = (_a = data.value) == null ? void 0 : _a.user) == null ? void 0 : _b.is_change_password) == 0) {
    if (to.path != "/change-password") {
      if (to.path != "/connexion")
        return navigateTo("/change-password");
    }
  }
  if (((_d = (_c = data.value) == null ? void 0 : _c.user) == null ? void 0 : _d.is_change_password) == 1) {
    if (to.path == "/change-password") {
      return navigateTo("/");
    }
  }
});
const maintenance_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to, redirect) => {
  useSession();
});
...
const globalMiddleware = [
  validate,
  change_45password_45global,
  maintenance_45global,
  manifest_45route_45rule
];
const namedMiddleware = {
  maintenancesite: () => import('./_nuxt/maintenancesite-1e02ca75.mjs')
};
...
function defineStore(idOrOptions, setup, setupOptions) {
  ...
  function useStore(pinia, hot) {
    ...
    (pinia) || (hasContext ? inject$2(piniaSymbol, null) : null);
    if (pinia)
      setActivePinia(pinia);
    pinia = activePinia;
    if (!pinia._s.has(id)) {
...
var DataView = _DataView, Map$4 = _Map, Promise$1 = _Promise, Set$2 = _Set, WeakMap$2 = _WeakMap, baseGetTag$5 = _baseGetTag, toSource = _toSource;
...
if (DataView && getTag$3(new DataView(new ArrayBuffer(1))) != dataViewTag$2 || Map$4 && getTag$3(new Map$4()) != mapTag$3 || Promise$1 && getTag$3(Promise$1.resolve()) != promiseTag || Set$2 && getTag$3(new Set$2()) != setTag$3 || WeakMap$2 && getTag$3(new WeakMap$2()) != weakMapTag$1) {
...
function baseClone$2(value, bitmask, customizer, key, object, stack) {
  ...
  var keysFunc = isFull ? isFlat ? getAllKeysIn$1 : getAllKeys : isFlat ? keysIn$2 : keys$4;
...
var pick_1 = pick$1;
const pick$1$1 = /* @__PURE__ */ getDefaultExportFromCjs(pick_1);
...
var omit_1 = omit$1;
const omit$1$1 = /* @__PURE__ */ getDefaultExportFromCjs(omit_1);
...
var clamp_1 = clamp$1;
const clamp$1$1 = /* @__PURE__ */ getDefaultExportFromCjs(clamp_1);
...
const mergeDeep$1 = (target, source) => {
  ...
  Object.keys(source).forEach((key) => {
    ...
    if (isObject$1(targetValue) && isObject$1(sourceValue)) {
      target[key] = mergeDeep$1(Object.create(
...
const createGlobalConfig = (defaultConfig = {}) => {
  const globalConfig = ref(mergeDeep$1(getDefaultConfig(), defaultConfig));
  ...
  const mergeGlobalConfig = (updater) => {
    const config = typeof updater === "function" ? updater(globalConfig.value) : updater;
    globalConfig.value = mergeDeep$1(cloneDeep$1(globalConfig.value), config);
  };
  return {
    getGlobalConfig,
    setGlobalConfig,
...
const provideForCurrentApp = (provide2) => {
  var _a, _b;
  const provides = ((_a = getCurrentInstance$1()) == null ? void 0 : _a.appContext.provides) || ((_b = getCurrentApp()) == null ? void 0 : _b._context.provides);
  if (!provides) {
...
function useGlobalConfig() {
  let injected = inject$1(GLOBAL_CONFIG);
  if (!injected) {
...
const useCache = () => {
  const cache = inject$1(VaAppCachePluginKey);
  if (!cache) {
    return {
      colorContrast: {}
    };
...
const cssVariableName = (colorName) => `--va-${kebabCase$1(colorName)}`;
...
const useColors = () => {
  ...
  const colorsToCSSVariable = (colors2, prefix = "va") => {
    return Object.keys(colors2).filter((key) => colors2[key] !== void 0).reduce((acc, colorName) => {
      acc[`--${prefix}-${kebabCase$1(colorName)}`] = getColor(colors2[colorName], void 0, true);
      acc[`--${prefix}-on-${kebabCase$1(colorName)}`] = getColor(getTextColor(getColor(colors2[colorName])), void 0, true);
      return acc;
    }, {});
  };
  ...
  const getTextColor = (color, darkColor, lightColor) => {
    const onColorName = `on${capitalize$2(String(color))}`;
...
const getGlobalProperty$1 = (app, key) => {
...
const createBreakpointConfigPlugin = (app) => {
  var _a;
  const globalConfig = (_a = getGlobalProperty$1(app, "$vaConfig")) == null ? void 0 : _a.globalConfig;
  if (!globalConfig) {
...
function useLocalConfig() {
  return inject$2(LocalConfigKey, CONFIGS_DEFAULT);
}
...
const createProxyComponent = (component) => {
  const customSetup = (originalProps, ctx) => {
    ...
    const attrsFromConfig = computed(() => {
      return omit$1$1(propsFromConfig.value, Object.keys(originalProps));
    });
...
const useSize$1 = (props, componentName = ((_a) => (_a = getCurrentInstance$1()) == null ? void 0 : _a.type.name)()) => {
...
const _sfc_main$8 = defineComponent$1({
  ...
  setup(props, { attrs }) {
    ...
    const { sizeComputed } = useSize$1(props);
    const { getIcon } = useIcon$1();
    ...
    const computedAttrs = computed(() => ({ ...iconConfig.value.attrs, ...omit$1$1(attrs, ["class"]) }));
...
const _VaIcon = /* @__PURE__ */ _export_sfc$1(_sfc_main$8, [["render", _sfc_render$4]]);
const useTimer = () => {
  let timer;
  const start = (...args) => {
...
const useTextColor$1 = (componentColor, isTransparent = false) => {
  const { props } = getCurrentInstance$1();
...
const VaToastRenderer = defineComponent$1({
...
const _sfc_main$7 = defineComponent$1({
  ...
  setup(props, { emit }) {
    ...
    const { getColor } = useColors();
    const { textColorComputed } = useTextColor$1(computed(() => getColor(props.color)));
...
const _VaToast = /* @__PURE__ */ _export_sfc$1(_sfc_main$7, [["render", _sfc_render$3]]);
...
const useRouterLink = (props) => {
  ...
  const globalProperties = computed(() => {
    var _a2;
    return (_a2 = getCurrentInstance$1()) == null ? void 0 : _a2.appContext.config.globalProperties;
  });
...
const VaIcon = withConfigTransport$1(_VaIcon);
const _sfc_main$6 = defineComponent$1({
  ...
  setup(props) {
    const { getColor } = useColors();
    const { sizeComputed } = useSize$1(props);
    const cappedThickness = computed(() => clamp$1$1(props.thickness, 0, 1) / 2 * 100);
    const radius = computed(() => 20 - 20 * cappedThickness.value / 100);
    const dasharray = computed(() => 2 * Math.PI * radius.value);
    const dashoffset = computed(() => dasharray.value * (1 - clamp$1$1(props.modelValue, 0, 100) / 100));
...
const _VaProgressCircle = /* @__PURE__ */ _export_sfc$1(_sfc_main$6, [["render", _sfc_render$2]]);
...
const checkSlotChildrenDeep = (v, initial = true) => {
  var _a;
  if (!v || initial && (!isFunction$4(v) || !((_a = v()) == null ? void 0 : _a.length))) {
    return false;
  }
...
const useSlotPassed = (name = "default") => {
  const { slots } = getCurrentInstance$1();
...
const useBem = (prefix, modifiers) => {
  ...
  const computedBemClassesObject = computed(() => {
    return Object.entries(unref(modifiersList)).reduce((classesObj, [modifierName, value]) => {
      if (value) {
        classesObj[`${prefix}--${kebabCase$1(modifierName)}`] = true;
      }
      return classesObj;
    }, {});
  });
...
const _sfc_main$5 = defineComponent$1({
  ...
  setup(props) {
    ...
    const { focus, blur } = useFocus$1(button);
    ...
    const computedClass = useBem("va-button", () => ({
      ...pick$1$1(props, ["disabled", "block", "loading", "round", "plain"]),
    ...
    const { textColorComputed } = useTextColor$1(colorComputed, isTransparentBg);
    const {
      backgroundColor,
      backgroundColorOpacity,
      backgroundMaskOpacity,
...
const _VaButton = /* @__PURE__ */ _export_sfc$1(_sfc_main$5, [["render", _sfc_render$1]]);
...
const useStateful = (props, emit, key = "modelValue", options = {}) => {
  const { eventName: eventName2, defaultValue } = options;
  const event = eventName2 || `update:${key.toString()}`;
...
const WithTransition = defineComponent$1({
  name: "ModalElement",
  inheritAttrs: false,
  props: {
    ...useComponentPresetProp,
...
const _sfc_main$4 = defineComponent$1({
  ...
  setup(props, { emit }) {
    ...
    const { getColor } = useColors();
    const { textColorComputed } = useTextColor$1(toRef(props, "backgroundColor"));
...
const _VaModal = /* @__PURE__ */ _export_sfc$1(_sfc_main$4, [["render", _sfc_render]]);
...
const isPluginFabric = (plugin2) => typeof plugin2 === "function";
const usePlugin = (app, plugin2, ...options) => {
  if (isPluginFabric(plugin2)) {
    app.use(plugin2(...options));
  } else {
    app.use(plugin2);
  }
};
...
const createVuesticEssential = defineVuesticPlugin((options = {}) => ({
  install(app) {
    const { config, components, plugins: plugins2 } = options;
    setCurrentApp(app);
    usePlugin(app, (plugins2 == null ? void 0 : plugins2.GlobalConfigPlugin) || GlobalConfigPlugin, config);
    usePlugin(app, (plugins2 == null ? void 0 : plugins2.CachePlugin) || CachePlugin);
    usePlugin(app, (plugins2 == null ? void 0 : plugins2.ColorConfigPlugin) || ColorConfigPlugin, config);
    if (plugins2) {
      Object.entries(plugins2).forEach(([name, plugin2]) => {
        if (ESSENTIAL_PLUGIN_NAMES.includes(name)) {
          return;
        }
        usePlugin(app, plugin2);
      });
    }
    if (components) {
...
const plugin_FRmGFsEaPh = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  var _a;
  const { vueApp: app } = nuxtApp;
  const moduleOptions = JSON.parse(`{"config":{},"css":["smart-helpers","typography"],"fonts":true,"themeCookieKey":"vuestic-theme"}`);
  const themeCookie = useCookie(moduleOptions.themeCookieKey);
  const userConfig = moduleOptions.config || {};
  const configWithColors = {
    ...userConfig,
    colors: {
      currentPresetName: themeCookie.value || ((_a = userConfig.colors) == null ? void 0 : _a.currentPresetName) || "light",
      ...userConfig.colors
    }
  };
  app.use(createVuesticEssential({
    config: { ...configWithColors, routerComponent: markRaw(__nuxt_component_0$2) },
...
const authMiddleware = /* @__PURE__ */ defineNuxtRouteMiddleware((to) => {
  ...
  const callbackUrl = (_a = authConfig.globalMiddlewareOptions) == null ? void 0 : _a.addDefaultCallbackUrl;
...
const plugin_AOuQ1DYzjk = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  let __temp, __restore;
  const { enableSessionRefreshOnWindowFocus, enableSessionRefreshPeriodically, enableGlobalAppMiddleware } = (/* @__PURE__ */ useRuntimeConfig()).public.auth;
...
const checker_BagWHNVREb = /* @__PURE__ */ defineNuxtPlugin(() => {
  return {
    provide: {
      checkSex: (tab) => {
...
const date_utils_dxmU43PVnl = /* @__PURE__ */ defineNuxtPlugin(() => {
  return {
    provide: {
      ...
      dateTimeformatFr: (date2) => {
        if (!date2)
          return null;
        const [date_, time_] = date2.replace(".000Z", "").split("T");
      ...
      dataFormatFrSerializer: (date2) => {
        if (!date2)
          return null;
        const [date_, time_] = date2.replace(".000Z", "").split("T");
        return date_;
      },
      dataFormatFrDeSerializer: (date2) => {
        if (!date2)
          return null;
...
const formData_vEpNMIe6QI = /* @__PURE__ */ defineNuxtPlugin(({}) => {
  return {
    provide: {
...
const normalizer_39m8cvpSkK = /* @__PURE__ */ defineNuxtPlugin(({}) => {
  return {
    provide: {
...
const utils_EEhlE5KdlH = /* @__PURE__ */ defineNuxtPlugin(() => {
  return {
    provide: {
      caxios: async (url) => {
        const data = await useFetch("/api" + url, "$8zie8LKw80");
      ...
      school_id: (school_id) => {
        var _a;
        const { data } = useSession();
        let user = (_a = data.value) == null ? void 0 : _a.user;
        return (user == null ? void 0 : user.school_id) ? user.school_id : school_id;
      }
    }
  };
});
const variable_qKlMJWZt6g = /* @__PURE__ */ defineNuxtPlugin(() => {
  return {
    provide: {
      id_exam_class: () => {
        return [];
...
function getNestedValue(obj, path, fallback) {
  ...
  if (obj == null)
    return fallback;
  return obj[path[last2]] === void 0 ? fallback : obj[path[last2]];
}
...
function injectDefaults() {
  const defaults = inject$2(DefaultsSymbol);
  if (!defaults)
...
function createSimpleFunctional(klass) {
  ...
  return genericComponent()({
    name: name ?? capitalize$2(camelize(klass.replace(/__/g, "-"))),
    props: {
      tag: {
        type: String,
        default: tag
...
function useLocale() {
  const locale = inject$2(LocaleSymbol);
  if (!locale)
...
function useLayout() {
  const layout = inject$2(VuetifyLayoutKey);
  if (!layout)
...
function createLayout(props) {
  const parentLayout = inject$2(VuetifyLayoutKey, null);
...
function useSelectionControl(props) {
  const group = inject$2(VSelectionControlGroupSymbol, void 0);
  const {
    densityClasses
  } = useDensity(props);
  const modelValue = useProxiedModel(props, "modelValue");
...
function createList() {
  const parent2 = inject$2(ListKey, {
...
const useNested = (props) => {
  ...
  function getPath(id) {
    ...
    let parent2 = id;
    while (parent2 != null) {
      path.unshift(parent2);
      parent2 = parents.value.get(parent2);
    }
    return path;
  }
  ...
  const nested = {
    ...
    root: {
      ...
      unregister: (id) => {
        ...
        const parent2 = parents.value.get(id);
        if (parent2) {
          const list = children.value.get(parent2) ?? [];
...
const useNestedItem = (id, isGroup) => {
  const parent2 = inject$2(VNestedSymbol, emptyNested);
  const uidSymbol = Symbol(getUid());
  const computedId = computed(() => id.value !== void 0 ? id.value : uidSymbol);
  const item = {
    ...parent2,
    id: computedId,
    open: (open, e) => parent2.root.open(computedId.value, open, e),
    openOnSelect: (open, e) => parent2.root.openOnSelect(computedId.value, open, e),
    isOpen: computed(() => parent2.root.opened.value.has(computedId.value)),
    parent: computed(() => parent2.root.parents.value.get(computedId.value)),
    select: (selected, e) => parent2.root.select(computedId.value, selected, e),
    isSelected: computed(() => parent2.root.selected.value.get(toRaw(computedId.value)) === "on"),
    isIndeterminate: computed(() => parent2.root.selected.value.get(computedId.value) === "indeterminate"),
    isLeaf: computed(() => !parent2.root.children.value.get(computedId.value)),
...
function useStack(isActive, zIndex, disableGlobalStack) {
  ...
  const parent2 = inject$2(StackSymbol, void 0);
...
const VMenu = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const overlay = ref();
    const parent2 = inject$2(VMenuSymbol, null);
...
function useVirtual(props, items) {
  ...
  const last2 = shallowRef(Math.ceil(
  ...
  function _calculateVisibleItems() {
    ...
    if (
      ...
      (direction !== UP || start < first.value) && (direction !== DOWN || end > last2.value)
    ) {
      const topOverflow = calculateOffset(first.value) - calculateOffset(start);
      const bottomOverflow = calculateOffset(end) - calculateOffset(last2.value);
    ...
    paddingBottom.value = calculateOffset(items.value.length) - calculateOffset(last2.value);
  }
  ...
  const computedItems = computed(() => {
    return items.value.slice(first.value, last2.value).map((item, index) => ({
      raw: item,
...
const VWindowItem = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const window2 = inject$2(VWindowSymbol);
...
const offsetProps = (() => {
  return breakpoints.reduce((props, val) => {
    const offsetKey = "offset" + capitalize$2(val);
    props[offsetKey] = {
      type: [String, Number],
      default: null
    };
...
const orderProps = (() => {
  return breakpoints.reduce((props, val) => {
    const orderKey = "order" + capitalize$2(val);
    props[orderKey] = {
      type: [String, Number],
      default: null
    };
...
function makeRowProps(prefix, def) {
  return breakpoints.reduce((props, val) => {
    const prefixKey = prefix + capitalize$2(val);
    props[prefixKey] = def();
    return props;
  }, {});
}
...
const plugins = [
  ...
  plugin_AOuQ1DYzjk,
  checker_BagWHNVREb,
  date_utils_dxmU43PVnl,
  formData_vEpNMIe6QI,
  normalizer_39m8cvpSkK,
  utils_EEhlE5KdlH,
  variable_qKlMJWZt6g,
  vuetify_7h9QAQEssH
];
...
const layouts = {
  default: () => import('./_nuxt/default-6cdb1eea.mjs').then((m) => m.default || m),
  home: () => import('./_nuxt/home-379ca1e0.mjs').then((m) => m.default || m),
  homemaintenance: () => import('./_nuxt/homemaintenance-1612ef02.mjs').then((m) => m.default || m)
};
...
const __nuxt_component_1 = defineComponent$1({
  ...
  setup(props, context) {
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
    const injectedRoute = inject$2(PageRouteSymbol);
...
const __nuxt_component_0 = defineComponent$1({
  ...
  setup(props, { attrs, expose }) {
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
    const pageRef = ref();
    inject$2(PageRouteSymbol, null);
    expose({ pageRef });
    inject$2(LayoutMetaSymbol, null);
    let vnode;
    const done = nuxtApp.deferHydration();
    return () => {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent2, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_snackbar, {
        modelValue: unref(snackbar).status,
        "onUpdate:modelValue": ($event) => unref(snackbar).status = $event,
        location: "top",
        color: unref(snackbar).type,
        timeout: unref(snackbar).timeout
      }, {
        actions: withCtx((_, _push2, _parent3, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_btn, {
              class: "text-white bg-black",
              onClick: ($event) => unref(snackbar).close()
            }, {
              default: withCtx((_2, _push3, _parent4, _scopeId2) => {
                if (_push3) {
                  _push3(` Fermer `);
                } else {
                  return [
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/u/Snackbar.vue");
...
const _sfc_main$2 = {};
function _sfc_ssrRender(_ctx, _push, _parent2, _attrs) {
  const _component_NuxtLoadingIndicator = __nuxt_component_0$1;
  const _component_NuxtLayout = __nuxt_component_1;
  const _component_NuxtPage = __nuxt_component_0;
  const _component_USnackbar = __nuxt_component_3;
  _push(`<div${ssrRenderAttrs(_attrs)}>`);
  _push(ssrRenderComponent(_component_NuxtLoadingIndicator, { color: "black" }, null, _parent2));
  _push(ssrRenderComponent(_component_NuxtLayout, null, {
    default: withCtx((_, _push2, _parent3, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_NuxtPage, null, null, _parent3, _scopeId));
        _push2(ssrRenderComponent(_component_USnackbar, null, null, _parent3, _scopeId));
      } else {
        return [
          createVNode(_component_NuxtPage),
          createVNode(_component_USnackbar)
        ];
      }
    }),
    _: 1
  ...
  setup(__props) {
    ...
    function replaceText(text) {
      if (text.includes("Page not found")) {
        texte = text.replace(/Page not found/g, "Page non retrouvée");
      } else {
        texte = text;
      }
    }
    return (_ctx, _push, _parent2, _attrs) => {
      ...
      _push(`<!--[--><div><div class="headers_"><div class="soso"><div class="line"><h1 class="" style="${ssrRenderStyle({ "color": "white" })}">Désolé !</h1></div></div><br>`);
      ...
      _push(`<h3 style="${ssrRenderStyle({ "color": "white" })}">${ssrInterpolate(__props.error.statusCode && __props.error.statusCode == "403" ? "Vous n'avez pas accès à cette page" : "")}${ssrInterpolate(__props.error.statusCode && __props.error.statusCode == "404" ? "la page que vous cherchez n'existe pas" : "")} ${ssrInterpolate(__props.error.statusCode && __props.error.statusCode == "500" ? "Problème serveur" : "")}</h3><br><p${ssrRenderAttr("text", replaceText(__props.error.message))}>${ssrInterpolate(unref(texte))}</p><br><a href="/" class="button" style="${ssrRenderStyle({ "background-color": "white", "color": "#093e73", "margin-right": "20px" })}">Retourner à l&#39;accueil</a></div></div>`);
        ...
        default: withCtx((_, _push2, _parent3, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_col, {
              ...
              default: withCtx((_2, _push3, _parent4, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} <strong${_scopeId2}>: EducMaster/ MESTFP / République du bénin. Tous droits réservés. Plateforme réalisée par </strong> <a href="https://ticsmaster.bj/" target="_blank" style="${ssrRenderStyle({ "text-decoration": "none" })}"${_scopeId2}>TICS MASTER SARL </a>`);
                } else {
                  return [
                    createTextVNode(toDisplayString((/* @__PURE__ */ new Date()).getFullYear()) + " ", 1),
                    createVNode("strong", null, ": EducMaster/ MESTFP / République du bénin. Tous droits réservés. Plateforme réalisée par "),
                    createTextVNode(),
                    createVNode("a", {
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-0c034b77.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { __nuxt_component_0$2 as _, useSession as a, useFetch as b, createError as c, useRequestHeaders as d, entry$1 as default, useHead as e, useNuxtApp as f, useDisplay as g, __nuxt_component_0 as h, defineNuxtRouteMiddleware as i, executeAsync as j, _export_sfc as k, navigateTo as n, useSnackbar as u };
