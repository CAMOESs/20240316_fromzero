...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    useHead({ title: "Utilisateurs & profils" });
    let items;
    let name = "utilisateur_profil";
    ({ data: items } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/my-menu/sub?name=" + name, "$glmVBXSsyX")), __temp = await __temp, __restore(), __temp));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/tableau-de-bord/utilisateurs-profils/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-3ac46d1c.mjs.map
